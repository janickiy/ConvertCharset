...
namespace Janickiy\ConvertCharset;
...
{
    public $RecognizedEncoding; // (boolean) This value keeps information if string contains multibyte chars.
    public $Entities; // (boolean) This value keeps information if output should be with numeric entities.
    public $FromCharset; // (string) This value keeps information about source (from) encoding
    public $ToCharset; // (string) This value keeps information about destination (to) encoding
    public $CharsetTable; // (array) This property keeps convert Table inside

    /**
     * @param $FromCharset
     * @param $ToCharset
     * @param bool $TurnOnEntities
     */
    public function ConvertCharset($FromCharset, $ToCharset, $TurnOnEntities = false)
    {
     ...
     * @return string
     */
    public function UnicodeEntity($UnicodeString)
    {
        $OutString = "";
     ...
     * @return string
     */
    public function HexToUtf($UtfCharInHex)
    {
        $OutputChar = "";
     ...
     * @return array
     */
    public function MakeConvertTable($FromCharset, $ToCharset = '')
    {
        $ConvertTable = array();
     ...
     * @return mixed|string
     */
    public function Convert($StringToChange)
    {
     ...
     * @return mixed
     */
    public function DebugOutput($Group, $Number, $Value = false)
    {
